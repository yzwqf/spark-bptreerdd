...
object BPTree {
  def main(args: Array[String]): Unit = {
    ...
    val l = new BPlusTree[Long, Long](new BPlusTreeConfig(512,512), "")
    ...
    val arr = l.range(1, 1000)
    arr.foreach(d => println(d))
    println( l.range(1.asInstanceOf[Long], 1000).length)



    // val l = new BPlusTree[Int, Int](new BPlusTreeConfig(512, 512), "")
    // println("inserting")
